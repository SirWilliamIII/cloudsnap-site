  ...
  <div id="contact-form" class="contact-form">
    <div class="row mx-auto" id="rowWrapper">
      <div class="col-md-10 offset-md-1 text-center">
        ...
        <h1 v-if="messageSent" class="contact-form-title-after">{{ cloudsnap.successMessage }}</h1>
        <p v-if="messageSent" class="lead" style="color: #fff;">{{ cloudsnap.successMessageSub }}</p>
...
export default {
  ...
  data() {
    return {
      ...
      cloudsnap: {
        ...
        successMessageSub:
          "Thanks for the inquiry! We will contact you shortly!"
      },
      isSending: false,
      messageSent: false
    };
  ...
  methods: {
    handleSubmit(e) {
      e.preventDefault();
      const url = "https://nuvola.numanage.io/support/new";
      this.isSending = true;
      let formData = {
